/*
        ...
        An example of using SorbaMqttWifi Library - Sending simulated data to SORBA and receive back raw messages
...
*/
// Example of how to send simulated data and receive back raw messages (string)
...
// Init communication parameters
 ...
 #define  MQTT_TOPIC_SUB "sorba/data/Asset1/Back" // Topic used for subscribing 
...
// Variables used to store the topic and payload when receiving messages from MQTT Broker
String topic;   // Message Topic
String payload; // Message Payload (raw data as string without parsing it as JSON)
...
void loop() {
  ...
  // How to receive a raw message from SORBA
  // Check if there are messages in queue extract it as String, if want to do parsing need to call .msgParse(string)
  // otherwise need to handle the payload as String
